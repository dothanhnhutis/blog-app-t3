/*
  ...
  - A unique constraint covering the columns `[code,email]` on the table `Otp` will be added. If there are existing duplicate values, this will fail.
...
-- DropIndex
DROP INDEX "Otp_code_userId_key";
